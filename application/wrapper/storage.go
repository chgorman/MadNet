...
func (s *Storage) GetMinTxFeeCostRatio() (*uint256.Uint256, error) {
	if s == nil {
		return nil, errorz.ErrInvalid{}.New("storage.GetMinTxFeeCostRatio; struct not initialized")
	}
	if s.storage == nil {
		return nil, errorz.ErrInvalid{}.New("storage.GetMinTxFeeCostRatio; storage not initialized")
	}
